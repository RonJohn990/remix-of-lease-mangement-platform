...
import { Plus, Trash2, Edit2, Loader2, Car, Building2 } from 'lucide-react';
  ...
  return (
    <div className="page-container animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">Define lease types and asset locations used across the system</p>
      </div>
